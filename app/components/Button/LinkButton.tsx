...
const bigCssClass = 'font-inter uppercase text-black/50 rounded-full px-12 py-4 text-base hover:bg-gradient-to-r from-green to-lightblue ';

const footerCssClass = 'text-black/50 rounded-3xl flex align-center justify-center p-7 bg-white hover:bg-gradient-to-r from-green to-lightblue lg:p-10 xl:p-12 '
