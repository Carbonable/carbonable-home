...
const modalCssClass = 'font-inter text-black/50 mt-8 uppercase rounded-full px-8 py-4 font-bold text-sm hover:bg-gradient-to-r from-green to-lightblue ';
const whitelistCssClass = 'font-inter text-black/50 uppercase rounded-full px-4 py-4 font-bold hover:bg-gradient-to-r from-green to-lightblue ';
