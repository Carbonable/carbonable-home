...
export default function Simulators({config}: any) {
    ...
    return (
        <div id="simulator" className="w-full scroll-mt-12 text-center mt-20 xl:mt-32 max-w-screen-2xl mx-auto scroll-snap-center">
            ...
            <div className="w-full max-w-screen-2xl mx-auto bg-home-simulator rounded-2xl shadow-home backdrop-blur-md py-4 px-2 md:w-11/12 md:mx-auto mt-8">
                <div className="w-full md:w-9/12 lg:w-6/12 p-1 flex font-semibold border border-white rounded-full items-center mx-auto justify-evenly uppercase text-xs md:text-base mt-1">
