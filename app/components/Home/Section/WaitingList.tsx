    ...
    return (
        <div className="bg-waiting-list bg-no-repeat bg-bottom bg-origin-padding rounded-2xl w-11/12 mx-auto py-2 px-2 mt-12 text-black md:w-10/12 md:px-12 xl:w-6/12">
            ...
            <div className="w-full text-center my-10 mx-auto md:mt-16 md:w-10/12">
                <div className={hasValidEmail ? 'bg-white mt-4 rounded-full w-full pl-4 pr-2 py-2 mx-auto flex lg:w-10/12' : 'bg-white mt-4 rounded-full w-11/12 pl-4 pr-2 py-2 mx-auto flex lg:w-10/12 border-2 border-red-400'}>
